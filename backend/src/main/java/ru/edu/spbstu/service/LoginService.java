...
public class LoginService {
    ...
    @Transactional
    public void sendTemporaryPassword(String login, Language language) {
        ...
        if (language.equals(Language.ENGLISH)) {
            emailSender.send(user.getEmail(), buildEmailEng(login, tempPassword), language);
        } else if (language.equals(Language.RUSSIAN)) {
            emailSender.send(user.getEmail(), buildEmailRus(login, tempPassword), language);
        }
    }
    ...
    private String buildEmailRus(String name, String password) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                "                      <span style=\"font-family:Helvetica,Arial,sans-serif;font-weight:700;color:#ffffff;text-decoration:none;vertical-align:top;display:inline-block\">Временный пароль</span>\n" +
                "                    </td>\n" +
                "                  </tr>\n" +
                "                </tbody></table>\n" +
                "              </a>\n" +
                ...
                "        \n" +
                "            <p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">Привет " + name + ",</p><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> Твой новый временный пароль: " +  password + " . Его следует сменить при первом входе в приложение</p>" +
                "        \n" +
                "      </td>\n" +
                "      <td width=\"10\" valign=\"middle\"><br></td>\n" +
                "    </tr>\n" +
    ...
    private String buildEmailEng(String name, String password) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                "\n" +
                "<span style=\"display:none;font-size:1px;color:#fff;max-height:0\"></span>\n" +
                "\n" +
